...
var _fetchCountriesJs = require("./js/fetchCountries.js");
var _inputJs = require("./js/input.js");

},{"./sass/style.scss":"fpeeO","./js/fetchCountries.js":"dKuy9","./js/input.js":"8nlno"}],"fpeeO":[function() {},{}],"8nlno":[function(require,module,exports) {
...
input.addEventListener("input", (0, _lodashDebounceDefault.default)(onSearch, 500));
function onSearch() {
    clearInput();
    const searchQuery = input.value.trim();
    if (!searchQuery) return;
    (0, _fetchCountriesDefault.default).fetchCountryByName(searchQuery).then((data)=>{
        if (data.length > 10) notification.tooMany();
...
},{"lodash.debounce":"3JP5n","./fetchCountries":"dKuy9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
